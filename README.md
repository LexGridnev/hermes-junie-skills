# Hermes-inspired Gemini CLI Skills

This repository contains skills for the Gemini CLI, adapted from the self-improving architecture of the [NousResearch/hermes-agent](https://github.com/nousresearch/hermes-agent).
...
- **Tiered Routing:** Maps facts to the correct Gemini CLI memory tier.

### 📝 [Workflow Distiller](./workflow-distiller)
Distills successful multi-step workflows into reusable Gemini CLI skills.
